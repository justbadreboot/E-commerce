    ...
    return(
        <div className="h-full border-1 bg-gray-100 border-gray-100 rounded-lg overflow-hidden shadow-md hover:shadow-xl font-poppins">
            <div className="mt-2 py-4 px-6">
                <h2 className="tracking-widest text-xs title-font font-medium text-gray-500 mb-2 uppercase">
                ...
                {user ? (
                    <>
                        <label htmlFor={service.id} className="cursor-pointer text-green-400 inline-flex font-semibold items-center md:mb-2 lg:mb-0">Agendar cita

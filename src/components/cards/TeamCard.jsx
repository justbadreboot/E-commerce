                        ...
                        <div key={member.id} className="p-4 mb-8 m-2 md:mb-0 bg-gray-100"
                            ...
                            <div className="mb-4 text-center opacity-90">
                                <div className="relative block">
                                    <img alt={member.nombre} src={member.img} className="mx-auto object-cover rounded-full h-40 w-40 "/>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-8 mx-auto text-gray-500 border-t border-gray-200 w-44">
                                <Link to={member.fb}>
                                    <svg width="30" height="30" fill="currentColor" className="text-xl transition-colors duration-200 hover:text-primary-100" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1343 12v264h-157q-86 0-116 36t-30 108v189h293l-39 296h-254v759h-306v-759h-255v-296h255v-218q0-186 104-288.5t277-102.5q147 0 228 12z">
                                        </path>
                                    </svg>
                                </Link>
                                <Link to={member.git}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="text-xl transition-colors duration-200 hover:text-primary-100" viewBox="0 0 1792 1792">

            ...
            <div className="mt-1 p-2">
                ...
                <div className="mt-1 flex items-end justify-between">
                    ...
                    <div className="tooltip" data-tip="Añadir al carrito">
                        <button onClick={()=> handleOnClick(user,product.id,1,product.pvp, product.name)} className=" gap-2 group inline-flex rounded-xl bg-warning-100 p-2 hover:bg-orange-20">

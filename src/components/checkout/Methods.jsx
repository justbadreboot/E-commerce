        ...
        <>
            ...
            <form className="mt-5 grid gap-6 grid-cols-1 sm:grid-cols-2">
                <div className="relative w-full">
                    ...
                    <label className="peer-checked:border-2 peer-checked:border-secondary-100 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor="radio_1">
                        <div className="ml-5">
                ...
                <div className="relative w-full">
                    ...
                    <span className="peer-checked:border-secondary-100 absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
                    <label className="peer-checked:border-2 peer-checked:border-secondary-100 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" htmlFor="radio_2">
                        <div className="ml-5">

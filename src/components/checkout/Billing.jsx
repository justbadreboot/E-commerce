...
const Billing =( )=>{
    return(
        ...
        <p class="text-xl font-medium">Datos para la Factura</p>
        ...
        <Link to='/envio'>
            <button class="mt-6 mb-8 w-full rounded-md bg-primary-80 px-6 py-3 font-medium text-white">Continuar con el envío</button>
        </Link>

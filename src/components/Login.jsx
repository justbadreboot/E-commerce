...
const Login = () =>{
    ...
    return(
        <div className="relative w-full py-8 px-5 flex flex-col items-center bg-primary-20 font-poppins">
            ...
            <div className="relative z-10 max-w-6xl w-full md:w-3/4 grid grid-cols-7 overflow-hidden rounded-lg shadow-xl">
                ...
                <div className="z-10 col-span-7 sm:col-span-2 md:col-span-1 h-full flex sm:flex-col border-t border-transparent items-center text-sm text-gray-500">
                    <button onClick={() => setIsForm({ login : true, register : false, forgotPW : false })} className={`py-1.5 w-full h-full sm:h-1/2 inline-flex flex-col justify-center items-center active:outline-none focus:outline-none ${isForm.login ? "bg-white bg-opacity-90 text-gray-800" : "text-white"}`}>
                    ...
                    <button onClick={() => setIsForm({ login : false, register : true, forgotPW : false })} className={`py-1.5 w-full h-full sm:h-1/2 inline-flex flex-col justify-center items-center active:outline-none focus:outline-none ${isForm.register ? "bg-white bg-opacity-90 text-gray-800" : "text-white"}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {/* ::Login Form */}
                <div onSubmit={handleSubmitLogIn} className={`px-8 lg:px-20 w-full h-full flex flex-col items-center justify-center bg-white bg-opacity-90 transition-all duration-150 ease-in transform ${!isForm.login && "opacity-0"}`}>

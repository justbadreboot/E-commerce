...
const Navbar = () =>{
    return(
        <section className="relative mx-auto">
            <nav className="flex justify-between bg-primary-100 text-white">
                <div className="px-5 xl:px-12 py-3 flex w-full items-center">
                    ...
                    <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                        ...
                        <li><a className="hover:text-gray-200" href="/">Servicios</a></li>
                ...
                <a className="xl:hidden flex mr-6 items-center" href="/">
                    ...
                    <span className="flex absolute -mt-5 ml-4">
                        <span className="animate-ping absolute inline-flex h-3 w-3 rounded-full bg-secondary-40"></span>
